...
enum {
    ...
    BLOCK_REFCOUNT_MASK =     (0xfffe),  // runtime 65534
    BLOCK_NEEDS_FREE =        (1 << 24), // runtime 16777216
    BLOCK_HAS_COPY_DISPOSE =  (1 << 25), // compiler 33554432
    BLOCK_HAS_CTOR =          (1 << 26), // compiler: helpers have C++ code  67108864
    BLOCK_IS_GC =             (1 << 27), // runtime  134217728
    BLOCK_IS_GLOBAL =         (1 << 28), // compiler  268435456
    BLOCK_USE_STRET =         (1 << 29), // compiler: undefined if !BLOCK_HAS_SIGNATURE 536870912
    BLOCK_HAS_SIGNATURE  =    (1 << 30), // compiler
    BLOCK_HAS_EXTENDED_LAYOUT=(1 << 31)  // compiler
};
    
    ///570425344 = 536870912 + 33554432   BLOCK_HAS_COPY_DISPOSE|BLOCK_USE_STRET
